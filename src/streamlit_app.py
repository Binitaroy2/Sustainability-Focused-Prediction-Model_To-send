...
def main():
    ...
    try:
        ...
        st.error(f"Prediction error: {e}. Check if features match the model's expected input.")
    ...
    if st.button("Predict"):
        try:
            ...
            st.error(f"Prediction error: {e}. Ensure input values are valid numbers and match model expectations (6 features).")
